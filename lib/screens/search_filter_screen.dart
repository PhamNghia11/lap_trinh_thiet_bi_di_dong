          ...
          body: SingleChildScrollView(
            ...
            child:
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: movieGenreOptions.keys
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text(
                    _rating == 0 ? 'Bất kỳ' : '${_rating.toStringAsFixed(1)} ★',
              ...
              Wrap(
                ...
                children: _sorts.entries
                    .map((entry) => ChoiceChip(
                          ...
                          onSelected: (_) =>
                              setState(() => _sortBy = entry.value),
                          selectedColor: AppTheme.primaryRed,
                          backgroundColor: AppTheme.cardBg,
                          labelStyle: TextStyle(
                            color: _sortBy == entry.value
                                ? Colors.white
                                : AppTheme.textMuted,
                          ),
                        ))
              ...
              PrimaryButton(
                ...
                text: 'Áp dụng bộ lọc',
                onPressed: () {
                  final sortLabel = _sorts.entries
